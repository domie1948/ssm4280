...
public class XiaoqugonggaoController {
     ...
     */
    @RequestMapping("/page")
    public R page(@RequestParam Map<String, Object> params,XiaoqugonggaoEntity xiaoqugonggao, HttpServletRequest request){
	...
	@IgnoreAuth
    @RequestMapping("/list")
    public R list(@RequestParam Map<String, Object> params,XiaoqugonggaoEntity xiaoqugonggao, HttpServletRequest request){
        EntityWrapper<XiaoqugonggaoEntity> ew = new EntityWrapper<XiaoqugonggaoEntity>();
    	PageUtils page = xiaoqugonggaoService.queryPage(params, MPUtil.sort(MPUtil.between(MPUtil.likeOrEq(ew, xiaoqugonggao), params), params));
		request.setAttribute("data", page);
        return R.ok().put("data", page);
