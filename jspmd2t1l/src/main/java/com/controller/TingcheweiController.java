...
public class TingcheweiController {
     ...
     */
    @RequestMapping("/page")
    public R page(@RequestParam Map<String, Object> params,TingcheweiEntity tingchewei, HttpServletRequest request){
     ...
     */
    @RequestMapping("/list")
    public R list(@RequestParam Map<String, Object> params,TingcheweiEntity tingchewei, HttpServletRequest request){
        EntityWrapper<TingcheweiEntity> ew = new EntityWrapper<TingcheweiEntity>();
    	PageUtils page = tingcheweiService.queryPage(params, MPUtil.sort(MPUtil.between(MPUtil.likeOrEq(ew, tingchewei), params), params));
		request.setAttribute("data", page);
        return R.ok().put("data", page);
