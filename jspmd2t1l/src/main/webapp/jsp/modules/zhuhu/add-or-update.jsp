...
<body>
						...
						<div class="widget-area-2 lochana-box-shadow">
							...
							<form id="addOrUpdateForm">
								<div class="form-row">
									...
									<div class="form-group col-md-6">
										<label>入住时间</label>
										<div id="ruzhushijianDate" class="input-append date form_datetime">
											<input id="ruzhushijian-input" name="ruzhushijian" size="15" type="text" readonly>
	...
	<script>
		...
		function dateTimePick(){
			...
			$("#ruzhushijianDate").datetimepicker({ 
				minView: "month",
				autoclose: true,
				format:'yyyy-mm-dd',
				language:'zh-CN',
