...
<body>
						...
						<div class="widget-area-2 lochana-box-shadow">
							...
							<form id="addOrUpdateForm">
								<div class="form-row">
									...
									<div class="form-group col-md-6">
										<label>任职时长</label>
										<input id="renzhishizhang" name="renzhishizhang" class="form-control" placeholder="任职时长">
									</div>
	...
	<script>
		...
		function dataBind(){
			...
			$("#renzhishizhang").val(ruleForm.renzhishizhang);	
		}		
		//图片显示
		function showImg(){
		...
		if(crossTableName != null && crossTableName != '' && crossTableId != null && crossTableId != '' && crossTableId != -1){
			http(crossTableName + "/info/" + crossTableId,"GET",{},(res)=>{
				if(res.code == 0){
					...
					if(res.data != null && res.data != '' && res.data.renzhishizhang != null && res.data.renzhishizhang != ''){

					$("#renzhishizhang").val(res.data.renzhishizhang);
					}
				}
			});  
            }
