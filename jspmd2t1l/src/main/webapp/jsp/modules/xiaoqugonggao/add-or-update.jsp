						...
						<div class="widget-area-2 lochana-box-shadow">
							...
							<form id="addOrUpdateForm">
								<div class="form-row">
									...
									<div class="form-group col-md-6">
										<label>公告类型</label>
										<select id="gonggaoleixingSelect" name="gonggaoleixing" class="form-control">
												<option value=""></option>
												<option class="gonggaoleixingOption" value="公告">
													公告
												</option>
												<option class="gonggaoleixingOption" value="安全知识">
													安全知识
												</option>
												<option class="gonggaoleixingOption" value="商业广告">
													商业广告
												</option>
										</select>	
									</div>	
	...
	<script>
		  ...
		  beforeCreate: function(){
			  var id = window.sessionStorage.getItem("id");
				if(id != null && id != "" && id != "null"){
					$.ajax({ 
		                type: "GET",
		                url: baseUrl + "xiaoqugonggao/info/" + id,
		...
		function submit() {
			if(validform() ==true && compare() == true){
				...
				httpJson("xiaoqugonggao/"+urlParam,"POST",data,(res)=>{
					if(res.code == 0){
		...
		function getDetails() {
			...
			if(id != null && id != "" && id != "null"){
				updateId = id;
				window.sessionStorage.removeItem('id');
				http("xiaoqugonggao/info/" + id,"GET",{},(res)=>{
					if(res.code == 0){
						ruleForm = res.data
						// 是/否下拉框回显
						setSelectOption();
		...
		function calculationSE(colName){
			//单列求和接口
			http("xiaoqugonggao"+colName,"GET",{
		...
		function dataBind(){
			...
			var gonggaoleixingOptions = document.getElementsByClassName("gonggaoleixingOption");
			for(var gonggaoleixingCount = 0; gonggaoleixingCount < gonggaoleixingOptions.length;gonggaoleixingCount++){
				if(gonggaoleixingOptions[gonggaoleixingCount].getAttribute('value') == ruleForm.gonggaoleixing){
					gonggaoleixingOptions[gonggaoleixingCount].setAttribute('selected','selected');
				}
			}
		}		
		//图片显示
		...
		if(crossTableName != null && crossTableName != '' && crossTableId != null && crossTableId != '' && crossTableId != -1){
			http(crossTableName + "/info/" + crossTableId,"GET",{},(res)=>{
				if(res.code == 0){
					...
					var gonggaoleixingOptions = document.getElementsByClassName("gonggaoleixingOption");
						for(var gonggaoleixingCount = 0; gonggaoleixingCount < gonggaoleixingOptions.length;gonggaoleixingCount++){
							if(gonggaoleixingOptions[gonggaoleixingCount].getAttribute('value') == res.data.gonggaoleixing){
								gonggaoleixingOptions[gonggaoleixingCount].setAttribute('selected','selected');
							}
						}
					}
